...
public class Lesson_3_Activity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerContentObject.add(new customArrayList(
                ...
                String.format(getString(R.string.Lesson_3_Question_1_Asked)),
                R.mipmap.thumbs_up_green_contextual,
                R.mipmap.thumbs_down_red_contextual,
                getString(R.string.Lesson_3_Question_1_answer),
                getString(R.string.Button_Submit),
                getString(R.string.Button_Clear))) ;
        //Question 2
        recyclerContentObject.add(new customArrayList(
                getString(R.string.Question_Number_2),
                String.format(getString(R.string.Lesson_3_Question_2_Asked)),
                R.mipmap.thumbs_up_green_contextual,
                R.mipmap.thumbs_down_red_contextual,
                getString(R.string.Lesson_3_Question_2_answer),
                getString(R.string.Button_Submit),
                getString(R.string.Button_Clear))) ;
        //Question 3
        recyclerContentObject.add(new customArrayList(
                getString(R.string.Question_Number_3),
                String.format(getString(R.string.Lesson_3_Question_3_Asked)),
                R.mipmap.thumbs_up_green_contextual,
                R.mipmap.thumbs_down_red_contextual,
                getString(R.string.Lesson_3_Question_3_answer),
                getString(R.string.Button_Submit),
                getString(R.string.Button_Clear))) ;
        //Question 4
        recyclerContentObject.add(new customArrayList(
                getString(R.string.Question_Number_4),
                String.format(getString(R.string.Lesson_3_Question_4_Asked)),
                R.mipmap.thumbs_up_green_contextual,
                R.mipmap.thumbs_down_red_contextual,
                getString(R.string.Lesson_3_Question_4_answer),
                getString(R.string.Button_Submit),
                getString(R.string.Button_Clear))) ;
        //Question 5
        recyclerContentObject.add(new customArrayList(
                getString(R.string.Question_Number_5),
                String.format(getString(R.string.Lesson_3_Question_5_Asked)),
                R.mipmap.thumbs_up_green_contextual,
                R.mipmap.thumbs_down_red_contextual,
                getString(R.string.Lesson_3_Question_5_answer),
                getString(R.string.Button_Submit),
                getString(R.string.Button_Clear))) ;
        //Question 6
        recyclerContentObject.add(new customArrayList(
                getString(R.string.Question_Number_6),
                String.format(getString(R.string.Lesson_3_Question_6_Asked)),
                R.mipmap.thumbs_up_green_contextual,
                R.mipmap.thumbs_down_red_contextual,
                getString(R.string.Lesson_3_Question_6_answer),
                getString(R.string.Button_Submit),
                getString(R.string.Button_Clear))) ;
